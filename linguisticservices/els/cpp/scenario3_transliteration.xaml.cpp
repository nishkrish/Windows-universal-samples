...
void Scenario3_Transliteration::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void Scenario3_Transliteration::Go_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
