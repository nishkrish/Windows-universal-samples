...
void Scenario1_LanguageDetection::OnNavigatedTo(NavigationEventArgs^ e)
{
...
void Scenario1_LanguageDetection::Go_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
